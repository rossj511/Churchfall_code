class CF_MalachisBook extends Trigger
placeable
ClassGroup(CF_Actors);
var bool IsInInteractionRange;
var CF_Malachis_Book_Movie MalachisBookMovie;
var bool bFirstOpening;
...
{
	MalachisBookMovie = new class'CF_Malachis_Book_Movie';
	if(bFirstOpening == true)
	{
		MalachisBookMovie.Init();
		MalachisBookMovie.triggerEvent=true;
		bFirstOpening=false;
	}
	else
	{
